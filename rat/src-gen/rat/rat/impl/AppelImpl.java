...
public class AppelImpl extends EImpl implements Appel
{
   ...
   * @generated
   */
  public EList<E> getParam()
  {
    if (param == null)
    {
      param = new EObjectContainmentEList<E>(E.class, this, RatPackage.APPEL__PARAM);
    }
    return param;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case RatPackage.APPEL__PARAM:
        getParam().clear();
        getParam().addAll((Collection<? extends E>)newValue);
        return;
    }
